 ...
 */
public interface CircularList3 {
    ...
    /**
     * Provides the next element that sadisfies a given condition
     * @param filter the given condition
     * @return the next element that sadisfies the condition
     */
